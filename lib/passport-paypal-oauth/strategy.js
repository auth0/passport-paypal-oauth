...
function Strategy(options, verify) {
  ...
  options.userInfoURL = options.userInfoURL || 'https://www.paypal.com/webapps/auth/protocol/openidconnect/v1/userinfo?schema=openid';
...
Strategy.prototype.userProfile = function(accessToken, done) {
  this._oauth2.getProtectedResource(this.options.userInfoURL, accessToken, function (err, body, res) {
