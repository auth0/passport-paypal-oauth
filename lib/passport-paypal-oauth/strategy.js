...
function Strategy(options, verify) {
  ...
  options.tokenURL = options.tokenURL || 'https://www.api.paypal.com/v1/identity/openidconnect/tokenservice';
...
Strategy.prototype.userProfile = function(accessToken, done) {
  this._oauth2.get('https://www.api.paypal.com/v1/identity/openidconnect/userinfo?schema=openid', accessToken, function (err, body, res) {
