...
function Strategy(options, verify) {
  ...
  options.authorizationURL = options.authorizationURL || 'https://' + host + '/webapps/auth/protocol/openidconnect/v1/authorize';
  options.tokenURL = options.tokenURL || 'https://' + host + '/webapps/auth/protocol/openidconnect/v1/tokenservice';
...
var USER_IR_PREFIX = 'https://[[HOST]]/webapps/auth/identity/user/';
...
Strategy.prototype.userProfile = function(accessToken, done) {
  ...
  USER_IR_PREFIX = USER_IR_PREFIX.replace( '[[HOST]]', host );

  this._oauth2.getProtectedResource('https://' + host + '/webapps/auth/protocol/openidconnect/v1/userinfo?schema=openid', accessToken, function (err, body, res) {
